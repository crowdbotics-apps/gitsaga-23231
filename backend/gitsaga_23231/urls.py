"""gitsaga_23231 URL Configuration
...
admin.site.site_header = "GitSaga"
admin.site.site_title = "GitSaga Admin Portal"
admin.site.index_title = "GitSaga Admin"

# swagger
api_info = openapi.Info(
    title="GitSaga API",
    default_version="v1",
    description="API documentation for GitSaga App",
)
